Prompt:
In SnakeStarter.java, add a main method that opens a 600x600 JFrame titled Snake Starter. Keep everything in one file. Add a starting snake that is three segments ong and draw it in green on the panel. Do not add movement yet.
